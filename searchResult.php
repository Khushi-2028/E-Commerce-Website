...
<div id="categoryArea">
  <?php 
     ...
     $rscat=mysqli_query($con,"select * from category_info where cat_name like '%$search%' order by cat_dname");
...
<div id="productArea">
  <?php 
     ...
     else 
     {
        ...
        include("dbconnect.php");
     $rscat=mysqli_query($con,"select * from product_info where prod_name like '%$search%'order by prod_name");
     while($row=mysqli_fetch_array($rscat))
     {
        $id=$row["prod_id"];
